...
public class OfferDetailsConstant {
    ...
    public static final String GENERIC_ERROR_MSG = "unknown error from service";

    public static final String DB_UNKNOWN_ERROR_CODE = "9999";
    public static final String DB_UNKNOWN_ERROR_MSG = "unknown error from database";
